# https://github.com/areshytko/productivity-dashboard
...
from dashboard.kpi.weekly_done import WeeklyDoneKPI
from dashboard.widgets import print_projects_pomodoros, projects_bar_chart
from dashboard.monthly import MonthlyGoalsData, MonthlyPercentageKPI
